...
test('network_uint32/4: bytes 0x01 to integer works') :-
	network_uint32( Result, [0,0,0,1], []),!,
	Result should_unify_with 1
	.
test('network_uint32/4: bytes 0xf0 << 24 to integer works') :-
	Expected is 0xf0 << 24,
	network_uint32( Result, [0xf0, 0, 0, 0], []),!,
	Result should_unify_with Expected
	.
test('network_uint32/4: bytes 0xf0 << 24 to integer leaves remaining bytes') :-
